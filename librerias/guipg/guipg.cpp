...
bool GUILib::ColorEdit(const std::string &label, glm::vec3 &color) {
	return ImGui::ColorEdit3(label.c_str(), (float*)&color.r);
}

bool GUILib::ColorEdit(const std::string &label, glm::vec4 &color) {
	return ImGui::ColorEdit4(label.c_str(), (float*)&color.r);
}
...
bool GUILib::SliderFloat(const std::string &label, float &value, float min, float max, const std::string &display_format, float power) {
	return ImGui::SliderFloat(label.c_str(), &value, min, max, display_format.c_str(), power);
}

bool GUILib::SliderFloat(const std::string &label, glm::vec2 &value, float min, float max, const std::string &display_format, float power)
{
	return ImGui::SliderFloat2(label.c_str(), &value.x, min, max, display_format.c_str(), power);
}
...
bool GUILib::SliderFloat(const std::string &label, glm::vec3 &value, float min, float max, const std::string &display_format, float power) {
	return ImGui::SliderFloat3(label.c_str(), &value.x, min, max, display_format.c_str(), power);
}
bool GUILib::SliderFloat(const std::string &label, glm::vec4 &value, float min, float max, const std::string &display_format, float power) {
	return ImGui::SliderFloat4(label.c_str(), &value.x, min, max, display_format.c_str(), power);
}
...
bool GUILib::ListBox(const std::string &label, int *current, const char * const items[], size_t count, int height_items) {
	return ImGui::ListBox(label.c_str(), current, items, gsl::narrow<int>(count), height_items);
}

bool GUILib::MultiListBoxBegin(const std::string & label)
{
	return ImGui::ListBoxHeader(label.c_str());
}
